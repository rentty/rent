...
public class FastJsonRedisSerializer<T> implements RedisSerializer<T> {
    ...
    static {
        ...
        ParserConfig.getGlobalInstance().addAccept("com.rent.common.RentException");
        ParserConfig.getGlobalInstance().addAccept("com.rent.common.Result");
        ParserConfig.getGlobalInstance().addAccept("com.rent.common.ResultCode");
        ParserConfig.getGlobalInstance().addAccept("com.rent.common.StringToDate");
        ParserConfig.getGlobalInstance().addAccept("com.rent.bean.ShowHouse");
